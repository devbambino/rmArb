...
contract LiquidityPool is Ownable {
    ...
    function withdraw() external {
        ...
        require(shareAmount <= asset.balanceOf(address(this)), "Not enough asset liquidity in LP to withdraw");

        //uint256 entitled = (IFeePool(feePool).claimableFees() * shareAmount) / totalShares;
        //uint256 claimable = entitled - IFeePool(feePool).claimed(msg.sender);
        //require(claimable == 0, "Rewards pending to be claimed!");
